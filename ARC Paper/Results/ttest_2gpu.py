...
sentiment_singularity_csv = '~/git/afit_mlperf_training/sentiment_analysis/results/2GPU_sentiment_analysis_singularity.csv'
sentiment_native_csv = '~/git/afit_mlperf_training/sentiment_analysis/results/2GPU_sentiment_analysis_native.csv'
...
native_df=native_df.drop([62,94])
