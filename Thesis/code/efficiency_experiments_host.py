...
def untransformed_sets(sample_length=1000, num_samples=1000, random_state=69):
    real_set_1 = load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=random_state, dist='uniform')
    real_set_2 = load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=2*random_state, dist='uniform')
    fake_set_1 = load_n_host_samples(real=False, num_samples=num_samples, 
                                sample_length=sample_length, random_state=random_state, dist='uniform')
    fake_set_2 = load_n_host_samples(real=False, num_samples=num_samples, 
                                sample_length=sample_length, random_state=2*random_state, dist='uniform')
    real_set_3 = load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=3*random_state, dist='uniform')
    real_set_4 = load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=4*random_state, dist='uniform')
...
def sqrt_sets(sample_length=1000, num_samples=1000, random_state=69):
    real_set_1 = np.sqrt(load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=random_state, dist='uniform'))
    real_set_2 = np.sqrt(load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=2*random_state, dist='uniform'))
    fake_set_1 = np.sqrt(load_n_host_samples(real=False, num_samples=num_samples, 
                                sample_length=sample_length, random_state=random_state, dist='uniform'))
    fake_set_2 = np.sqrt(load_n_host_samples(real=False, num_samples=num_samples, 
                                sample_length=sample_length, random_state=2*random_state, dist='uniform'))
    real_set_3 = np.sqrt(load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=3*random_state, dist='uniform'))
    real_set_4 = np.sqrt(load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=4*random_state, dist='uniform'))
...
def log_sets(sample_length=1000, num_samples=1000, random_state=69):
    real_set_1 = np.log(load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=random_state, dist='uniform')+1)
    real_set_2 = np.log(load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=2*random_state, dist='uniform')+1)
    fake_set_1 = np.log(load_n_host_samples(real=False, num_samples=num_samples, 
                                sample_length=sample_length, random_state=random_state, dist='uniform')+1)
    fake_set_2 = np.log(load_n_host_samples(real=False, num_samples=num_samples, 
                                sample_length=sample_length, random_state=2*random_state, dist='uniform')+1)
    real_set_3 = np.log(load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=3*random_state, dist='uniform')+1)
    real_set_4 = np.log(load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=4*random_state, dist='uniform')+1)
...
def pca_sets(sample_length=1000, num_samples=1000, random_state=69):
    real_set_1_ = load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=random_state, dist='uniform')
    real_set_2_ = load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=2*random_state, dist='uniform')
    fake_set_1_ = load_n_host_samples(real=False, num_samples=num_samples, 
                                sample_length=sample_length, random_state=random_state, dist='uniform')
    fake_set_2_ = load_n_host_samples(real=False, num_samples=num_samples, 
                                sample_length=sample_length, random_state=2*random_state, dist='uniform')
    real_set_3_ = load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=3*random_state, dist='uniform')
    real_set_4_ = load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=4*random_state, dist='uniform')
...
for num_samples in num_sample_list:
    ...
    real_data_untrans.to_csv(outdir+'real_data_exp_eff_host_uniform_{}.csv'.format(num_samples))
    fake_data_untrans.to_csv(outdir+'fake_data_exp_eff_host_uniform_{}.csv'.format(num_samples))
print("Untransformed")
t_elapsed = time.time()
...
for num_samples in num_sample_list:
    ...
    outdir = '/home/mnewlin/git/AFIT/Thesis/code/results/sqrt/'
    real_data_sqrt.to_csv(outdir+'real_data_exp_eff_host_uniform_{}.csv'.format(num_samples))
    fake_data_sqrt.to_csv(outdir+'fake_data_exp_eff_host_uniform_{}.csv'.format(num_samples))
print("Square Root")
t_elapsed = time.time()
t_so_far = t_elapsed - t_start
print("Total time elapsed: {:.2f}".format(t_so_far))
...
for num_samples in num_sample_list:
    ...
    outdir = '/home/mnewlin/git/AFIT/Thesis/code/results/log/'
    real_data_log.to_csv(outdir+'real_data_exp_eff_host_uniform_{}.csv'.format(num_samples))
    fake_data_log.to_csv(outdir+'fake_data_exp_eff_host_uniform_{}.csv'.format(num_samples))
print("Log")
t_elapsed = time.time()
t_so_far = t_elapsed - t_start
print("Total time elapsed: {:.2f}".format(t_so_far))
...
for num_samples in num_sample_list:
    ...
    outdir = '/home/mnewlin/git/AFIT/Thesis/code/results/pca/'
    real_data_pca.to_csv(outdir+'real_data_exp_eff_host_uniform_{}.csv'.format(num_samples))
    fake_data_pca.to_csv(outdir+'fake_data_exp_eff_host_uniform_{}.csv'.format(num_samples))
print("PCA")
t_elapsed = time.time()
t_so_far = t_elapsed - t_start
print("Total time elapsed: {:.2f}".format(t_so_far))
...
for num_samples in num_sample_list:
    ...
    outdir = '/home/mnewlin/git/AFIT/Thesis/code/results/fft/'
    real_data_fft.to_csv(outdir+'real_data_exp_eff_host_uniform_{}.csv'.format(num_samples))
    fake_data_fft.to_csv(outdir+'fake_data_exp_eff_host_uniform_{}.csv'.format(num_samples))
print("FFT")
