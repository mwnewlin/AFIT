...
def untransformed_sets(sample_length=1000, num_samples=1000, random_state=69):
    real_set_1 = load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=random_state, dist='normal')
    real_set_2 = load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=2*random_state, dist='normal')
    ...
    real_set_3 = load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=3*random_state, dist='normal')
    real_set_4 = load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=4*random_state, dist='normal')
...
def log_sets(sample_length=1000, num_samples=1000, random_state=69):
    real_set_1 = np.log(load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=random_state, dist='normal')+1)
    real_set_2 = np.log(load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=2*random_state, dist='normal')+1)
    ...
    real_set_3 = np.log(load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=3*random_state, dist='normal')+1)
    real_set_4 = np.log(load_n_host_samples(real=True, num_samples=num_samples, 
                                sample_length=sample_length, random_state=4*random_state, dist='normal')+1)
...
real_data_untrans.to_csv(outdir+'real_data_exp_host_normal.csv')
fake_data_untrans.to_csv(outdir+'fake_data_exp_host_normal.csv')
print("Untransformed")
t_elapsed = time.time()
...
real_data_sqrt.to_csv(outdir+'real_data_exp_host_normal.csv')
fake_data_sqrt.to_csv(outdir+'fake_data_exp_host_normal.csv')
print("Square Root")
t_elapsed = time.time()
t_so_far = t_elapsed - t_start
print("Total time elapsed: {:.2f}".format(t_so_far))
...
real_data_log.to_csv(outdir+'real_data_exp_host_normal.csv')
fake_data_log.to_csv(outdir+'fake_data_exp_host_normal.csv')
print("Log")
t_elapsed = time.time()
t_so_far = t_elapsed - t_start
print("Total time elapsed: {:.2f}".format(t_so_far))
...
real_data_pca.to_csv(outdir+'real_data_exp_host_normal.csv')
fake_data_pca.to_csv(outdir+'fake_data_exp_host_normal.csv')
print("PCA")
t_elapsed = time.time()
t_so_far = t_elapsed - t_start
print("Total time elapsed: {:.2f}".format(t_so_far))
...
real_data_fft.to_csv(outdir+'real_data_exp_host_normal.csv')
fake_data_fft.to_csv(outdir+'fake_data_exp_host_normal.csv')
print("FFT")
t_end = time.time()
