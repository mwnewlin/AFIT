...
real_data_sqrt.to_csv(outdir+'real_data_exp.csv')
fake_data_sqrt.to_csv(outdir+'fake_data_exp.csv')
print("Square Root")
...
real_data_log.to_csv(outdir+'real_data_exp.csv')
fake_data_log.to_csv(outdir+'fake_data_exp.csv')
print("Log")
...
real_data_pca.to_csv(outdir+'real_data_exp.csv')
fake_data_pca.to_csv(outdir+'fake_data_exp.csv')
print("PCA")
...
real_data_fft.to_csv(outdir+'real_data_exp.csv')
fake_data_fft.to_csv(outdir+'fake_data_exp.csv')
print("FFT")
